      ...
      <div className="w-full rounded-lg bg-white-a700 p-5 shadow-xl">
        <div className="flex gap-[30px]">
          <div className="flex flex-col items-start gap-4 sm:gap-4">
            <Text className="text-[18px] font-bold text-black-900_02 sm:text-[15px]">Title 1</Text>
          ...
          <div className="flex flex-col items-start gap-4 sm:gap-4">
            <Text className="text-[18px] font-bold text-black-900_02 sm:text-[15px]">Title 2</Text>
            <div className="flex flex-col items-start gap-3 sm:gap-3">
              <a href="#" className="sm:text-[13px]">
                <Text className="text-[16px] font-normal text-black-600">Menu 1</Text>
              </a>
          ...
          <div className="flex flex-col items-start gap-4 sm:gap-4">
            <Text className="text-[18px] font-bold text-black-900_02 sm:text-[15px]">Title 3</Text>
            <div className="flex flex-col items-start gap-3 sm:gap-3">
              <a href="#" className="sm:text-[13px]">
                <Text className="text-[16px] font-normal text-black-600">Menu 1</Text>
              </a>
